...
//------------------------------------------------------
let phoneNumber = "62895332438125"
...
markOnlineOnConnect: true,
   ...
   if (pairingCode && !Yuta.authState.creds.registered) {
      ...
      setTimeout(async () => {
         ...
         console.log(chalk.black(chalk.bgGreen(`Selamat Datang Ke Script: Yuta-Botz By: YutaBoT`)))
...
"retailerId": `LynnZxD`,
"url": "wa.me/6283833371747"
},
"businessOwnerJid": "15122377700@s.whatsapp.net",
"contextInfo": {isForwarded: true, mentionedJid: [num]}
},
}), { userJid: m.chat, quoted:  { key: { participant: '0@s.whatsapp.net', remoteJid: "0@s.whatsapp.net" }, message: { conversation: 'Welcome By Yuta Fungsi By Yuta' }}})    
